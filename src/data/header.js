...
const headerData = {
  title: 'Digitaland - Digitally Limitless',
  ...
  navItems,
  navItemsTwo,
  address: 'Larangan, Tangerang, Banten',
  phone: '+6285315187253',
  phone2: '+6285315187253',
  email: 'needhelp@digitaland.biz.id',
  icon,
  socials,
  text: 'Digitaland is a premium Template for Digital Agencies, Start Ups, Small Business and a wide range of other agencies.',
};
